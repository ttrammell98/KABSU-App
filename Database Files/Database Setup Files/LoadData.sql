LOAD DATA INFILE '<REPLACE THIS WITH A FILEPATH FOR People.csv>'
INTO TABLE person
...
LOAD DATA INFILE '<REPLACE THIS WITH A FILEPATH FOR ANIMAL.CSV>'
INTO TABLE animal
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES terminated by '\n'
...
LOAD DATA INFILE '<REPLACE WITH FILEPATH TO SAMPLE.CSV>'
